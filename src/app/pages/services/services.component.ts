...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, HeaderOneComponent, ServiceAreaOneComponent, VisionAreaTwoComponent, PortfolioAreaOneComponent, FooterFourComponent, FooterOneComponent],
